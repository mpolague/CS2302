...
class HashTableLP(object):
    ...
    def find(self,k,bullet):
        ...
        for i in range(len(self.item)):
            ...
            pos = self.h((wordemb.word),bullet,i)
            if self.item[pos] == k:
                return pos
            if self.item[pos] == -1:
                return -1
